<?php
/**
 * ASAP_LinkedInOAuth2 Class
 * 
 * @package ASAP_LinkedInOAuth2 Class
 */

//Include OAuth2 class
require_once APSL_PLUGIN_DIR . "linkedin/OAuth2.class.php";

class APSL_LinkedInOAuth2 extends apsl_OAuth2 {
	...
	public function getProfileEmail($access_token2, $id_user, $userEmail=''){
			$params	= array();
			//die($access_token2);
			$params['url']		= 'https://api.linkedin.com/v2/clientAwareMemberHandles?q=members&projection=(elements*(primary,type,handle~))&grant_type=authorization_code&='.$access_token2;
			$params['method']	= 'get';
			$params['format']	= 'json';
			$result				= $this->makeRequest( $params );
