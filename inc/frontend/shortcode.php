        ...
        <div class='social-networks'>
            <?php foreach ($options['network_ordering'] as $key => $value): ?>
                <?php if ($options["apsl_{$value}_settings"]["apsl_{$value}_enable"] === 'enable') { ?>
                    ...
                    <a href='javascript:void(0);' onclick="apsl_open_in_popup_window(event, '<?php echo $link; ?>');" title='<?php
                    ...
                    ?>'>
                        ...
                        ?> clearfix">
                            ...
                            <?php echo isset($attr['theme']) && $attr['theme'] == '20' ? '<span class="login-longshort-text-wrapper">' : ''; ?>

                            <?php echo isset($attr['theme']) && $attr['theme'] == '20' ? '<span class="apsl-social-media-text">' . $value . '</span>' : ''; ?>
                            ...
                            <span class="apsl-long-login-text" <?php echo isset($attr['theme']) && $attr['theme'] == '30' ? 'data-hover="' . $value . '"' : ''; ?>><?php
                            ...
                            <?php echo isset($attr['theme']) && $attr['theme'] == '20' ? '</span>' : ''; ?>
                            <?php if (isset($attr['theme']) && $attr['theme'] == '28') { ?>
