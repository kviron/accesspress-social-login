    ...
    <body>
        <div class='apsl-registration-wrapper'>
            <div class="apsl-login-wrap">
                ...
                <div class='apsl-buttons-wrapper clearfix' style="<?php
                if (isset($_POST['apsl_complete_registration']) || isset($_POST['apsl_login_details_submit'])) {
                    echo "display:none";
                } else {
                    echo "display:block";
                }
                ...
                <div class='apsl-registration-form' style='<?php
                if (isset($_POST['apsl_complete_registration'])) {
                    echo "display:block";
                } else {
                    echo "display:none";
                    ...
                    <form action='' method='POST' class="clearfix">
                        <?php if (isset($options['apsl_custom_username_allow']) && $options['apsl_custom_username_allow'] == 'allow') { ?>
                            <div class='apsl-registration-form-wrapper' >
                                ...
                                <input type='text' name='apsl-username-input' value='<?php
                                if (isset($_POST['apsl-username-input'])) {
                                    echo $_POST['apsl-username-input'];
                                } else {
                                    echo $username;
                                }
                                ?>' id='apsl-username-input' required/>
                        ...
                        <?php if (isset($options['apsl_custom_email_allow']) && $options['apsl_custom_email_allow'] == 'allow') { ?>
                            <div class='apsl-registration-form-wrapper'><label for='apsl-email-input' ><?php echo _e('Email:', APSL_TEXT_DOMAIN); ?></label><input type='email' name='apsl-email-input' value='<?php
                                if (isset($_POST['apsl-email-input'])) {
                                    echo $_POST['apsl-email-input'];
                                } else {
                                    echo $user_object->email;
                                }
                                ?>' id='apsl-email-input' required /></div>
                                                                                                                                                               <?php } ?>
                        ...
                        </div>		<a href='javascript:void(0);'><div class='apsl-back-button'>  â†? <?php echo _e('Back', APSL_TEXT_DOMAIN); ?></div></a>
                    </form>

                </div>
                <div class='apsl-login-form' style='<?php
                if (isset($_POST['apsl_login_details_submit'])) {
                    echo "display:block";
                } else {
                    echo "display:none";
                ...
                ?>'>
                    ...
                    <form method="post" action="" class="clearfix" id='apsl-username-register'>
                        ...
                        <a href='javascript:void(0);'><div class='apsl-back-button'> â†? <?php echo _e('Back', APSL_TEXT_DOMAIN); ?></div></a></form>
                </div>
            </div>
