...
<div class="apsl-profile-mapping-wrapper">
	<div class="apsl-label"><?php esc_attr_e('XProfile Mapping Enable?', APSL_TEXT_DOMAIN ); ?> <span class='apsl_show_hide'><i class="fa fa-caret-down"></i></span> </div>
	<div class='apsl_network_settings_wrapper apsl-profile-mapping' style='display:none'>
		<input type='radio' id='apsl-profile-mapping-enabled' class='apsl-profile-mapping-enabled apsl_profile_mapping_options' name='apsl_profile_mapping_options' value='yes' <?php if(isset($options['apsl_profile_mapping_options'])){ checked( $options['apsl_profile_mapping_options'], 'yes', 'true' ); } ?> /> <label for='apsl-profile-mapping-enabled'><?php esc_attr_e('Yes', APSL_TEXT_DOMAIN ); ?></label><br /><br />
		<input type='radio' id='apsl-profile-mapping-disabled' class='apsl-profile-mapping-disabled apsl_profile_mapping_options' name='apsl_profile_mapping_options' value='no' <?php if(isset($options['apsl_profile_mapping_options'])){ checked( $options['apsl_profile_mapping_options'], 'no', 'true' ); } ?> /> <label for='apsl-profile-mapping-disabled'><?php esc_attr_e('No', APSL_TEXT_DOMAIN ); ?></label><br /><br />
	</div>
</div>
</div>
...
<div class="apsl-profile-mapping-wrapper">
	<div class="apsl-label"><?php esc_attr_e('Fields Mapping', APSL_TEXT_DOMAIN ); ?> <span class='apsl_show_hide'><i class="fa fa-caret-down"></i></span> </div>
