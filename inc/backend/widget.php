...
class APSL_Widget extends WP_Widget {
    ...
    public function form($instance) {
        ...
        ?>
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_attr_e('Title: ', APSL_TEXT_DOMAIN); ?></label>
            <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>">
        </p>

        <p>
            <label for="<?php echo $this->get_field_id('login_text'); ?>"><?php esc_attr_e('Login Text: ', APSL_TEXT_DOMAIN); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('theme'); ?>"><?php esc_attr_e('Theme: ', APSL_TEXT_DOMAIN); ?></label> 
            <select name="<?php echo $this->get_field_name('theme'); ?>">
                <?php for ($i = 1; $i <= 30; $i++) { ?>
                    <option value="<?php echo $i; ?>" <?php selected($theme, $i); ?>><?php esc_attr_e($i, APSL_TEXT_DOMAIN); ?></option>
                <?php } ?>
            </select>
        </p>
...
class APSL_Widget_With_Login_Form extends WP_Widget {
    ...
    public function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('template'); ?>"><?php esc_attr_e('Template: ', APSL_TEXT_DOMAIN); ?></label> 
            <select name="<?php echo $this->get_field_name('template'); ?>">
        <?php for ($i = 1; $i <= 4; $i++) { ?>
                    <option value="<?php echo $i; ?>" <?php selected($template, $i); ?>><?php esc_attr_e($i, APSL_TEXT_DOMAIN); ?></option>
        <?php } ?>
            </select>
        </p>
